...
pub struct Policy {
    ...
    block_device_on_hazards: HashMap<u16, Hazards>,
}
...
impl Policy {
    ...
    /// [`Device`] with the given identifier and [`Hazards`].
    #[must_use]
    #[inline]
    pub fn no_global_policy(id: u16, hazards: Hazards) -> Self {
    ...
    #[must_use]
    #[inline]
    pub fn block_device_on_hazards(mut self, id: u16, hazards: Hazards) -> Self {
...
mod tests {
    ...
    fn no_global_policy() {
        ...
        let policy = Policy::no_global_policy(1, local_hazards.clone())
