...
use crate::request::{create_requests_senders, RequestInfo, RequestSender};
...
impl Device {
    ...
    ///
    /// This method might be useful when a device needs to be created
    /// from data contained in a database.
    #[must_use]
    pub fn new(
        network_info: NetworkInformation,
        description: Description,
    ...
    /// Returns a vector of [`RequestInfo`].
    #[must_use]
    #[inline]
